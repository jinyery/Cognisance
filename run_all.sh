...
func() {
    ...
    echo "DATASET, the dataset of task.(COCO_LT/ImageNet_LT/Places_GLT/Animal10N/Food101N, default to ImageNet_LT)"
...
"denosing")
    ...
    python -u main.py --cfg config/$DATASET.yaml --output_dir $OUTPUT_DIR/BBN --require_eval --train_type BBN --phase train --seed $SEED
    python -u main.py --cfg config/$DATASET.yaml --output_dir $OUTPUT_DIR/blsoftmax --require_eval --train_type blsoftmax --phase train --seed $SEED
    python -u main.py --cfg config/$DATASET.yaml --output_dir $OUTPUT_DIR/LA --require_eval --train_type LA --phase train --seed $SEED
    python -u main.py --cfg config/$DATASET.yaml --output_dir $OUTPUT_DIR/mixup --require_eval --train_type mixup --phase train --seed $SEED
    python -u main.py --cfg config/$DATASET.yaml --output_dir $OUTPUT_DIR/rand_aug --require_eval --train_type rand_aug --phase train --seed $SEED
    ...
    python -u main.py --cfg config/$DATASET.yaml --output_dir $OUTPUT_DIR/multi_center_dual --require_eval --train_type multi_center_dual --phase train --seed $SEED $DENOSING
    python -u main.py --cfg config/$DATASET.yaml --output_dir $OUTPUT_DIR/multi_center_dual_mixup --require_eval --train_type multi_center_dual_mixup --phase train --seed $SEED
    ...
    python -u main.py --cfg config/$DATASET.yaml --output_dir $OUTPUT_DIR/multi_center_dual_triplet --require_eval --train_type multi_center_dual_denosing --phase train --seed $SEED
    python -u main.py --cfg config/$DATASET.yaml --output_dir $OUTPUT_DIR/multi_center_dual_denosing --require_eval --train_type multi_center_dual_denosing --phase train --seed $SEED --denosing
    ;;
*)
