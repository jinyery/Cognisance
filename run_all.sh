...
python -u main.py --cfg config/COCO_LT.yaml --output_dir checkpoints/coco_glt/train/center_dual_cos --require_eval --train_type center_dual_cos --phase train
...
python -u main.py --cfg config/COCO_LT.yaml --output_dir checkpoints/coco_glt/train/multi_center_dual_cos --require_eval --train_type multi_center_dual_cos --phase train
...
python -u main.py --cfg config/COCO_LT.yaml --output_dir checkpoints/coco_glt/train/multi_center_dual_false_cos --require_eval --train_type multi_center_dual_false_cos --phase train
